...
def main(tr):
    ...
    for episode in range(NUM_EPISODES):
        ...
        if episode % 10 == 0:
            target_model.set_weights(main_model.get_weights())
        f = open("/Users/tartmsu/Desktop/result_run2.txt", "a")
        ...
        print(f"Two Episode {episode + 1}/{NUM_EPISODES}, Total Reward: {total_reward}, Done: {done}, Done: {total_done}, Collision: {total_collision} ,Epsilon: {epsilon:.2f}")
