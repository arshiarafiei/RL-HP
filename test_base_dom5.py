...
def train_dqn(env, max_steps, num_episodes, batch_size, gamma, epsilon_decay, tr):
    ...
    for episode in range(num_episodes):
        ...
        print(f"Episode {episode}, Total Reward: {total_reward}, Total Dones: {total_dones}, Total Dones: {domino_strings}, Epsilon: {epsilon}")
...
if __name__ == "__main__":
    ...
    for i in range(1,10):
      folder_path = "/Users/tartmsu/Desktop/RL-HP/data/dom_base5_3"
