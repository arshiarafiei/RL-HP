...
def main(tr):
    ...
    for episode in range(NUM_EPISODES):
        ...
        print(f"base2 Pent (5,10) {tr} : Episode {episode + 1}/{NUM_EPISODES}, Total Reward: {total_reward}, Done: {done}, Done: {total_done}, Collision: {total_collision} ,Epsilon: {epsilon:.2f}")
        arr = [episode, total_done, total_collision,s]
        df.loc[len(df)] = arr
        st = "data/pent_base_4/"+str(tr)+".csv"
